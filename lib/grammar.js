...
var parser = (function(){
    var parser = {trace: function trace() { },
        yy: {},
        symbols_: {"error":2,"ruleset":3,"selector":4,"comma":5,"EOF":6,"root":7,"simple_selector":8,"space":9,">":10,"*":11,"identity":12,".":13,"$accept":0,"$end":1},
        terminals_: {2:"error",5:"comma",6:"EOF",7:"root",9:"space",10:">",11:"*",12:"identity",13:"."},
        productions_: [0,[3,1],[3,3],[3,2],[4,1],[4,1],[4,3],[4,3],[8,1],[8,1],[8,2],[8,3]],
        performAction: function anonymous(yytext,yyleng,yylineno,yy,yystate,$$,_$) {
            ...
            switch (yystate) {
                ...
                case 3:return $$[$0-1];
                    break;
                case 4:this.$ = createFilterRoot();
                    break;
                case 5:this.$ = createUnionOr(createUnionAnd(createFilterRoot(),$$[$0]),createDescendantUnion(createFilterRoot(), $$[$0]));
                    break;
                case 6:this.$ = createDescendantUnion($$[$0-2], $$[$0]);
                    break;
                case 7:this.$ = createChildrenUnion($$[$0-2], $$[$0]);
                    break;
    ...
    var lexer = (function(){
        ...
        lexer.performAction = function anonymous(yy,yy_,$avoiding_name_collisions,YY_START) {
            ...
            switch($avoiding_name_collisions) {
                case 0:return 12;
                    break;
                case 1:yy_.yytext = this.matches[1].replace(/\\"/g, '"');return 12;
                    break;
                case 2:yy_.yytext = this.matches[1].replace(/\\'/g, '\'');return 12;
                    break;
                case 3:return 7;
                    break;
                case 4:return 10;
        ...
        lexer.rules = [/^(?:(\w|\d)+)/,/^(?:"((?:\w|\d|\\")+)")/,/^(?:'((?:\w|\d|\\')+)')/,/^(?::root)/,/^(?:\s*>\s*)/,/^(?:\s+)/,/^(?:\.)/,/^(?:\*)/,/^(?:\s*,\s*)/,/^(?:$)/];
