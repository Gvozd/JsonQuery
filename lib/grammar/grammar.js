...
define([
    'grammar/util',
    'combinator/createGreaterCombinator',
    'combinator/createSpaceCombinator',
    'filters/createFilterAny',
    'filters/createFilterName',
    'filters/notImplemented',
    'filters/createFilterType',
    'pseudo/createFilterHas',
    'pseudo/createFilterFirstChild',
    'pseudo/createFilterLastChild',
    'pseudo/createFilterNthChild',
    'pseudo/createFilterNthLastChild',
    'pseudo/createFilterRoot',
    'pseudo/getFunctionalPseudoFilter',
    'pseudo/getPseudoFilter',
    'union/createUnionAnd',
    'union/createUnionOr'
], function (
    util,
    ...
    createFilterType,
    createFilterHas,
    createFilterFirstChild,
    createFilterLastChild,
    createFilterNthChild,
    createFilterNthLastChild,
    createFilterRoot,
    getFunctionalPseudoFilter,
    getPseudoFilter,
    createUnionAnd,
    createUnionOr
    ) {
