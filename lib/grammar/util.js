...
define(function(require, exports, module) {
    ...
    function combinatorSequence(patterns, haystack, position) {
        var result = [],
            ...
            r,
            i;
        if(patterns.length === 2 && patterns[0].name === 'simple_selector_sequence') {
            debugger;
        }
    ...
    exports.optionalRepeat = function (pattern, separator, includeSeparator) {
        var result = combinatorOptional.bind(exports, combinatorRepeat.bind(exports, pattern, separator, includeSeparator))
        result.then = exports.then.bind(exports, result);
        return result;
    };
