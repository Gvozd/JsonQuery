...
case 2:this.$ = $$[$0];
break;
case 3:this.$ = createUnionOr($$[$0-3], $$[$0]);
break;
case 4:this.$ = createUnionOr(createUnionAnd(createFilterRoot(),$$[$0]),createSpaceCombinator(createFilterRoot(), $$[$0]));
break;
case 5:this.$ = $$[$0-1]($$[$0-2], $$[$0]);
break;
case 6:this.$ = notImplemented(arguments);
break;
case 7:this.$ = createGreaterCombinator;
break;
case 8:this.$ = notImplemented(arguments);
break;
case 9:this.$ = createSpaceCombinator;
break;
case 10:this.$ = createUnionAnd.apply(null, [$$[$0-1]].concat($$[$0]));
break;
case 11:this.$ = createUnionAnd.apply(null, $$[$0]);
break;
case 12:this.$ = notImplemented(arguments);
break;
case 13:this.$ = createFilterType($$[$0]);
break;
case 14:this.$ = notImplemented(arguments);
break;
case 15:this.$ = notImplemented(arguments);
break;
case 16:this.$ = notImplemented(arguments);
break;
case 17:this.$ = $$[$0];
break;
case 18:this.$ = notImplemented(arguments);
break;
case 19:this.$ = createFilterAny();
break;
case 20:this.$ = createFilterName($$[$0]);
break;
case 21:this.$ = createFilterName(eval($$[$0]));
break;
case 22:this.$ = notImplemented(arguments);
break;
case 23:this.$ = notImplemented(arguments);
break;
case 24:this.$ = notImplemented(arguments);
break;
case 25:this.$ = notImplemented(arguments);
break;
case 26:this.$ = notImplemented(arguments);
break;
case 27:this.$ = getPseudoFilter($$[$0]);
break;
case 28:this.$ = getPseudoFilter($$[$0]);
break;
case 29:this.$ = $$[$0];
break;
case 30:this.$ = $$[$0];
break;
case 31:this.$ = getFunctionalPseudoFilter($$[$0-4], $$[$0-1]);
break;
case 32:this.$ = this.$.join('');
break;
case 33:this.$ = notImplemented(arguments);
break;
case 34:this.$ = notImplemented(arguments);
break;
case 35:this.$ = notImplemented(arguments);
break;
case 36:this.$ = notImplemented(arguments);
break;
case 37:this.$ = notImplemented(arguments);
break;
case 38:this.$ = notImplemented(arguments);
break;
case 39:this.$ = notImplemented(arguments);
break;
case 40:this.$ = [];
break;
case 41:$$[$0-1].push($$[$0]);
